    ...
    def execute_trade(self, new_order, price, counter_side):
        ...
        while new_order.quantity > 0 and counter_order_queue:
            ...
            if best_counter_order.quantity > new_order.quantity:  # Full match
                ...
                self.order_book.modify_user_balance(new_order.user, -price * new_order.quantity, counter_side)
                ...
                self.order_book.modify_user_balance(new_order.user, -price * best_counter_order.quantity, counter_side)
