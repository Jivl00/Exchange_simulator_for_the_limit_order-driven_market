...
def main():
    ...
    order_book.add_order(Order(1, 0, 'buy', 100, 20.0))
    order_book.add_order(Order(21, 1, 'buy', 100, 10.0))
    order_book.add_order(Order(22, 2, 'buy', 100, 10.0))
    order_book.add_order(Order(23, 3, 'buy', 100, 10.0))

    order_book.add_order(Order(2, 1, 'sell', 50, 30.0))
    order_book.add_order(Order(2.1, 2, 'sell', 100, 30.0))
    order_book.add_order(Order(3, 2, 'sell', 100, 25.0))
    ...
    fifo_matching_engine.match_order(Order(4, 4, 'buy', 310, 30.0))
    order_book.display_order_book()
